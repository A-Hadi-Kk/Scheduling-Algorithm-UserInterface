...
class SJFSchedulerApp:
    def __init__(self, master):
        self.master = master
        self.master.title("SJF CPU Scheduling")
    ...
    def show_process_input_window(self, num_processes):
        ...
        submit_button = tk.Button(process_input_window, text="Submit", command=lambda: self.run_sjf_scheduling(num_processes))
        submit_button.pack()

    def run_sjf_scheduling(self, num_processes):
        processes = []
        ...
        self.sjf_scheduling(processes)
        self.show_gantt_chart_and_statistics("SJF Scheduling", processes)
